...
FocusScope {
    ...
    readonly property var pages: [
        ...
        { id: "dock", section: "Shell", icon: "dock",
          title: "Dock", source: "pages/DockPage.qml",
          blurb: "Which programs sit in it, which edge it is on, and whether it is a dock or a taskbar." },
